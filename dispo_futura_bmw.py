...
# Leer el archivo CSV en un DataFrame
df_mara = pd.read_excel(f"C:/Users/{usuario}/Inchcape/Planificación y Compras Chile - Documentos/Planificación y Compras KPI-Reportes/Gerenciamiento MOS/Data Homologación/MARA/1. MARA_BMW.xlsx")
...
# %%
df_ddp = df_ddp.merge(cadena_de_remplazo, left_on='Último Eslabón', right_on='Nro_pieza_fabricante_1', how='left')
df_ddp['Cod_Actual_1'] = df_ddp['Cod_Actual_1'].fillna(df_ddp['Último Eslabón'])
...
# %%
df_ddp['Segmentación Inchcape'].rename('Segmentacion', inplace=True)

# %%
df_ddp = df_ddp.rename(columns={'Segmentación': 'Segmentacion'})
...
# %%
df_ddp.rename(columns ={'Segmentación Inchcape':'Segmentacion'}, inplace=True)
...
# %%
df_base_aux.to_excel(f"C:/Users/{usuario}/Inchcape/Planificación y Compras Chile - Documentos/Planificación y Compras KPI-Reportes/Disponibilidad Futura/BMW/base_final.xlsx", index=False)
...
df_transformado.to_csv(f'C:/Users/{usuario}/Inchcape/Planificación y Compras Chile - Documentos/Planificación y Compras KPI-Reportes/Disponibilidad Futura/BMW/base_pbi.csv')
